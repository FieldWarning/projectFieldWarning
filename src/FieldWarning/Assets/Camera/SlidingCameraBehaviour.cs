...
namespace PFW
{
    ...
    public class SlidingCameraBehaviour : MonoBehaviour
    {
        ...
        /// <summary>
        /// Update() only plans movement; position/rotation are directly
        /// changed in LateUpdate().
        /// </summary>
        private void Update()
        {
            // Camera panning:
        ...
        {
            ScreenCorner mouseScreenCorner = GetScreenCornerForMousePosition(
        ...
        static public ScreenCorner GetScreenCornerForMousePosition(
                float borderPanningOffset, float borderPanningCornerSize)
        {
