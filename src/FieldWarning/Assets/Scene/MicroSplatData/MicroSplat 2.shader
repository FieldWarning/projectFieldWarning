...
UNITY_INSTANCING_BUFFER_END(Terrain)
   ...
   // ADVANCEDTERRAIN_ENTRYPOINT 
      ...
      #endif
      {
         ...
         #elif _PERPIXNORMAL
            float3 geomNormal = (UnpackNormal(UNITY_SAMPLE_TEX2D_SAMPLER(_PerPixelNormal, _Diffuse, i.uv_Control0))).xzy;
            worldNormalVertex = geomNormal;
         #endif    
...
ENDCG
   ...
   Dependency "BaseMapShader" = "Hidden/MicroSplat/Terrain_Base1581308544"
