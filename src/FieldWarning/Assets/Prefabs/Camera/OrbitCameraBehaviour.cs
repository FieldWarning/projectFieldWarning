...
public class OrbitCameraBehaviour : MonoBehaviour {
    ...
    [SerializeField] private float maxCameraAngle = 85;
    [SerializeField] private float minCameraAngle = 5;

    [Header("Zoom Level")]
    [SerializeField] private float zoomSpeed = 1000;
    [SerializeField] private float zoomTiltSpeed = 3;
    [SerializeField] private int minAltitude = 2;
    [SerializeField] private int maxAltitude = 2000;
